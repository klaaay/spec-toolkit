...
description: 设计 deep module 的共享 vocabulary。用户要设计或改进 module interface、寻找 deepening opportunity、决定 seam 位置、提升可测试性或 AI 可导航性，或其他 Skill 需要 deep-module vocabulary 时使用。
---
