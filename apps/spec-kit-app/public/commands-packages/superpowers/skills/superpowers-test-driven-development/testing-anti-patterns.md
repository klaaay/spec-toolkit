...
**何时参考：** 编写或修改测试时、添加模拟时，或想要向生产代码添加仅测试方法时。

## 概述

测试必须验证真实行为，而不是模拟行为。模拟是用来隔离的工具，不是被测试的对象。
...
**如果你在测试模拟行为，你违反了 TDD** - 你在没有先看到测试对真实代码失败的情况下添加了模拟。
...
如果 TDD 揭示你在测试模拟行为，你就走错了路。

修复：测试真实行为，或质疑你为什么需要模拟。
